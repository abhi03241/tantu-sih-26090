...
import ShilpVaniLogo from '../common/ShilpVaniLogo';
  ...
  return (
    <div style={{ padding: '24px 16px', minHeight: '80vh', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
      ...
      <div style={{ textAlign: 'center', marginTop: '14px' }}>
        <button
          onClick={() => speakText("शिल्पवाणी में आपका स्वागत है। आगे बढ़ने के लिए अपनी भाषा चुनकर नारंगी बटन दबाएं।")}
